...
/* ============================================================
   WHERE DINÂMICO
============================================================ */
$where = "WHERE aprovado = 0 AND estado = 0";
...
/* 🔤 Ordenação */
$ordemSQL = "ORDER BY analise_por IS NOT NULL, IDcri DESC";
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <form method="GET" id="filtrosForm"
                ...
                <div class="flex mt-6 items-center justify-end">
                    <button type="button"
                        onclick="window.location.href='criancaspendentes.php'"
            ...
            <div class="w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                ...
                <?php if (mysqli_num_rows($result) === 0): ?>
                    ...
                    <p class="text-center text-gray-600 dark:text-gray-300">
                        Não existem crianças pendentes.
                    </p>
                        ...
                        <div class="bg-green-50 dark:bg-green-900/20 shadow-md rounded-lg p-6 hover:shadow-xl transition">
                            ...
                            <div class="flex justify-start">
                                <a href="analisa_crianca.php?id=<?= $c['IDcri'] ?>"
                                    class="px-4 py-2 bg-green-500 dark:bg-green-600 text-white 
                                           rounded-lg hover:bg-green-600 dark:hover:bg-green-500 transition">
                                    Analisar
                                </a>
                            </div>
...
<!-- TOAST: criança aprovada -->
<?php if (isset($_GET['sucesso']) && $_GET['sucesso'] === 'aprovado'): ?>
<script>
window.addEventListener("load", () => {
    mostrarMensagem("adicionar", "Criança aprovada com sucesso!");
});
</script>
<?php endif; ?>

<!-- TOAST: criança rejeitada -->
<?php if (isset($_GET['sucesso']) && $_GET['sucesso'] === 'rejeitado'): ?>
<script>
window.addEventListener("load", () => {
    mostrarMensagem("eliminar", "Criança rejeitada com sucesso!");
});
</script>
<?php endif; ?>
