...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['data_inicio'])) {
    ...
    if ($diaSemana != 1) {
        ...
        // Erro → mostrar toast nesta página
        $mensagem = "erro_segunda";
        ...
        // REDIRECIONAR PARA LISTAGEM COM TOAST
        header("Location: listarrefeicao.php?sucesso=adicionado");
        exit();
    }
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <?php
            ...
            else include("menu_mobile_admin.php");
        ?>
...
<!-- TOAST -->
<?php if (isset($mensagem) && $mensagem === "erro_segunda"): ?>
<script>
window.addEventListener("load", () => {
    mostrarMensagem("reset", "A data escolhida deve ser uma segunda-feira.");
});
</script>
<?php endif; ?>
