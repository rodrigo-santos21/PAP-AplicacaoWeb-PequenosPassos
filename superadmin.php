    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8">
                Dashboard do Super Administrador / Bem-vindo, <?= $_SESSION['user']; ?>
            </h1>

            <!-- CARDS -->
            <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">

                <!-- CARD MODELO (repete para todos) -->
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Utilizadores</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Gerir contas e permissões.</p>
                    <a href="listarutlsuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listaratvsuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarreusuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    <div class="flex items-center mb-2">
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Salas</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Gerir salas e educadores.</p>
                    <a href="listarsalasuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarcrisuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarocosuper.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarrefeicao.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="superadmin_presencas.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="logs.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    <div class="flex items-center mb-2">
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-100">Inativos</h3>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mb-4">Gerir dados desativados</p>
                    <a href="superadmin_inativos.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">
                        Ver mais →
                    </a>
                </div>
