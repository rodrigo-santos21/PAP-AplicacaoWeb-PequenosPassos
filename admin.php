...
<body class="bg-gray-100 text-gray-900 min-h-screen 
    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8">Dashboard do Administrador / Bem-vindo, <?= $_SESSION['user']; ?> </h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarutl.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listaratv.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarreu.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarsala.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listacri.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listaroco.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="listarrefeicao.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 hover:shadow-2xl dark:hover:shadow-gray-400 transition">
                    ...
                    <a href="admin_presencas.php" class="text-green-600 dark:text-green-400 font-semibold hover:underline">Ver mais →</a>
                </div>
