...
<div id="mobileMenu" class="hidden lg:hidden bg-white dark:bg-gray-800 dark:text-gray-100 shadow-md p-4 space-y-2">
    ...
    <?php
    function linkMobile($file, $text, $pagina) {
        $ativo = $pagina === $file;
    ...
    echo linkMobile("superadmin.php", "Página Inicial", $pagina);
    echo linkMobile("adicionarutlsuper.php", "Adicionar Utilizador", $pagina);
    echo linkMobile("listarutlsuper.php", "Lista Utilizadores", $pagina);
    echo linkMobile("adicionaratvsuper.php", "Adicionar Atividade", $pagina);
    echo linkMobile("listaratvsuper.php", "Listar Atividades", $pagina);
    echo linkMobile("adicionarreusuper.php", "Adicionar Reunião", $pagina);
    echo linkMobile("listarreusuper.php", "Listar Reuniões", $pagina);
    echo linkMobile("adicionarsalasuper.php", "Adicionar Sala", $pagina);
    echo linkMobile("listarsalasuper.php", "Listar Salas", $pagina);
    echo linkMobile("adicionarcrisuper.php", "Adicionar Criança", $pagina);
    echo linkMobile("listarcrisuper.php", "Listar Crianças", $pagina);
    echo linkMobile("listarocosuper.php", "Listar Ocorrências", $pagina);
    echo linkMobile("adicionar_menu_semana.php", "Adicionar Refeições", $pagina);
    echo linkMobile("listarrefeicao.php", "Listar Refeições", $pagina);
    echo linkMobile("superadmin_presencas.php", "Presenças", $pagina);
    echo linkMobile("logs.php", "Consultar Logs", $pagina);
    echo linkMobile("superadmin_inativos.php", "Gerir Inativos", $pagina);
    ?>
