...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!isset($erro)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: listacri.php?sucesso=adicionado");
            exit();
        } else {
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <div class="w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                ...
                <?php if (isset($_GET['sucesso'])): ?>
                    <div class="bg-green-200 dark:bg-green-700 text-green-800 dark:text-green-100 p-3 rounded mb-4">
                ...
                <form method="post" class="space-y-5">
                    ...
                    <!-- EDUCADORES -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Educadores</label>
                    ...
                    <!-- SALA -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sala</label>
