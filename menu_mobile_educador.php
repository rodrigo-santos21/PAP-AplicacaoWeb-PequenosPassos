...
<?php
function linkMobileEdu($file, $text, $pagina) {
    $ativo = $pagina === $file;
...
echo linkMobileEdu("educador.php", "Página Inicial", $pagina);
echo linkMobileEdu("educador_presencas.php", "Presenças", $pagina);
echo linkMobileEdu("listarcrisuper.php", "Crianças", $pagina);
echo linkMobileEdu("listarocosuper.php", "Ocorrências", $pagina);
echo linkMobileEdu("listarrefeicao.php", "Refeições", $pagina);
?>
