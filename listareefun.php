...
/* ============================================================
   WHERE DINÂMICO
============================================================ */
$where = "WHERE estado = 1 AND tipo = 'encarregado'";
...
<!-- TOAST: Encarregado editado -->
<?php if (isset($_GET['sucesso']) && $_GET['sucesso'] === 'editado'): ?>
<script>
window.addEventListener("load", () => {
    mostrarMensagem("editar", "Encarregado atualizado com sucesso!");
});
</script>
<?php endif; ?>
...
<script>
window.addEventListener("load", () => {
    mostrarMensagem("reset", "Erro ao atualizar o encarregado.");
});
</script>
<?php endif; ?>
</body>
