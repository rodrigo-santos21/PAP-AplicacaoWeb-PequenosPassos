    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <form method="GET" id="filtrosForm"
                ...
                <div class="flex mt-6 items-center justify-end">
                    <button type="button"
                        ...
                        class="text-gray-500 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-500 
                               transition text-2xl"
            ...
            <?php if (isset($_GET['emailconfirmacao'])): ?>
                <div class="bg-blue-200 dark:bg-blue-900 text-blue-800 dark:text-blue-200 
                            p-4 rounded mb-6 text-center font-semibold shadow">
    ...
    document.getElementById("btnConfirmarEliminar").addEventListener("click", function () {
        ...
        .then(res => {
            ...
            if (res === "ok") {
                ...
                mostrarMensagem("reset", "Erro ao eliminar o utilizador.");
            }
        });
    });
</script>
...
window.addEventListener("load", () => {
    mostrarMensagem("adicionar", "Utilizador adicionado com sucesso!");
});
</script>
<?php endif; ?>

<!-- TOAST: utilizador editado -->
