...
<?php
function linkMobileFun($file, $text, $pagina) {
    $ativo = $pagina === $file;
...
echo linkMobileFun("funcionario.php", "Página Inicial", $pagina);
echo linkMobileFun("inscricoespendentes.php", "Inscrições Pendentes", $pagina);
echo linkMobileFun("criancaspendentes.php", "Crianças Pendentes", $pagina);
echo linkMobileFun("listarcrifun.php", "Listar Crianças", $pagina);
echo linkMobileFun("listareefun.php", "Listar Encarregados de Educação", $pagina);
echo linkMobileFun("listaredufun.php", "Listar Educadores", $pagina);
echo linkMobileFun("listarreufun.php", "Listar Reuniões", $pagina);
echo linkMobileFun("listarocofun.php", "Listar Ocorrências", $pagina);
echo linkMobileFun("funcionario_refeicoes.php", "Listar Refeições", $pagina);
echo linkMobileFun("funcionario_presencas.php", "Presenças", $pagina);
echo linkMobileFun("logs.php", "Consultar Logs", $pagina);
?>
