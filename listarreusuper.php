...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: 'listarreusuper.php?action=events',

        eventClick: function (info) {
            const id = info.event.id;

            fetch('listarreusuper.php?action=get&id=' + id)
                .then(r => r.json())
                .then(data => {
                    ...
                    if (data.educadores.length > 0) {
                        ...
                        fetch("listarreusuper.php?action=getSalaEducador&id=" + data.educadores[0])
                            .then(r => r.json())
                            .then(salaData => {
                                ...
                                fetch("listarreusuper.php?action=getEducadores&sala=" + sala)
                                    .then(r => r.text())
                                    .then(html => {
                    ...
                    if (data.encarregados.length > 0) {
                        ...
                        fetch("listarreusuper.php?action=getSalaEncarregado&id=" + data.encarregados[0])
                            .then(r => r.json())
                            .then(salaData => {
                                ...
                                fetch("listarreusuper.php?action=getEncarregados&sala=" + sala)
                                    .then(r => r.text())
                                    .then(html => {
    ...
    document.getElementById('formReuniao').addEventListener('submit', function (e) {
        ...
        fetch('listarreusuper.php?action=update', {
            method: 'POST',
   ...
   ============================================================ */
    ...
    document.getElementById('confirmarEliminar').addEventListener('click', function () {
        ...
        fetch('listarreusuper.php?action=delete', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: formData.toString()
        })
            ...
            .then(data => {
                if (data.success) {
                    ...
                    mostrarMensagem("reset", "Erro ao eliminar reunião.");
