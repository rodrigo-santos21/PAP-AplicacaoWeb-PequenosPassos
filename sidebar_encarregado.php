    ...
    <div class="flex flex-col h-full justify-between">
        ...
        <div>
            ...
            <nav class="space-y-3">
                ...
                <?php
                function linkEE($file, $text, $pagina, $icon)
                {
                    $ativo = $pagina === $file;
                ...
                echo linkEE("encarregado.php", "Página Inicial", $pagina, '<i class="fa-solid fa-house mr-2"></i>');
                echo linkEE("adicionarcriee.php", "Adicionar Criança", $pagina, '<i class="fa-solid fa-child mr-2"></i>');
                echo linkEE("listarcriee.php", "Listar Crianças", $pagina, '<i class="fa-solid fa-children mr-2"></i>');
                echo linkEE("listarocoee.php", "Listar Ocorrências", $pagina, '<i class="fa-solid fa-triangle-exclamation mr-2"></i>');
                echo linkEE("listaratvee.php", "Listar Atividades", $pagina, '<i class="fa-solid fa-list mr-2"></i>');
                echo linkEE("listarreuee.php", "Listar Reuniões", $pagina, '<i class="fa-solid fa-calendar-days mr-2"></i>');
                echo linkEE("encarregado_refeicoes.php", "Listar Refeições", $pagina, '<i class="fa-solid fa-bowl-food mr-2"></i>');
                echo linkEE("encarregado_presencas.php", "Ver Presenças", $pagina, '<i class="fa-solid fa-user-check mr-2"></i>');
                ?>
