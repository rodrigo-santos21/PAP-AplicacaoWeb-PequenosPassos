...
/* ============================================================
   1) VERIFICAR PERMISSÕES (SUPERADMIN)
   ============================================================ */
...
<head>
    <meta charset="utf-8">
    <title>Presenças - Superadmin</title>
...
<body class="bg-gray-100 dark:bg-gray-900 dark:text-gray-100 min-h-screen">
    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8">Ver Presenças</h1>

            <a href="superadmin.php"
            class="mb-4 inline-block px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-md font-semibold mt-5 
            ...
            <div class="w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                ...
                <form method="get">
                    ...
                    <select name="crianca" onchange="this.form.submit()"
                            class="border border-gray-300 dark:border-gray-600 p-2 rounded w-full mb-6 
                                bg-white dark:bg-gray-700 dark:text-gray-100">
                ...
                <?php if ($id_crianca_sel): ?>
                    <div id="calendar" class="dark:bg-gray-800 dark:text-gray-100"></div>
                <?php endif; ?>
            ...
            <div id="modalFalta" 
                ...
                <div class="bg-white dark:bg-gray-800 w-[400px] mx-auto p-5 rounded-lg z-[10000]">
                    ...
                    <textarea id="faltTexto" class="border p-2 w-full mb-3 dark:bg-gray-800" readonly></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: function(fetchInfo, successCallback) {
            ...
            fetch("getPresencasSuperadmin.php?id_crianca=" + id)
                .then(r => r.json())
