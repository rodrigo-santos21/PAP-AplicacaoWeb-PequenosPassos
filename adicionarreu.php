    ...
    <div class="flex min-h-screen flex-col lg:flex-row">
        ...
        <main class="flex-1 p-6 lg:p-10 lg:ml-[20%] overflow-y-auto">
            ...
            <div class="w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                ...
                <div id="erroBox" 
                     class="hidden bg-red-200 dark:bg-red-700 text-red-800 dark:text-red-100 
                            p-3 rounded mb-4"></div>
                ...
                <form id="formReuniao" class="space-y-6">
                    ...
                    <!-- PARTICIPANTES -->
                    <h3 class="text-lg font-semibold dark:text-gray-100">Participantes</h3>

                    <!-- FUNCIONÁRIOS -->
                    <button type="button" onclick="toggle('sec_func')"
                            class="w-full bg-gray-200 dark:bg-gray-700 dark:text-gray-100 
                                   p-2 rounded">
                        Funcionários
                    </button>
                    ...
                    <div id="sec_func" class="hidden p-3 border border-gray-300 dark:border-gray-600 rounded">
                        ...
                        <div id="lista_funcionarios"
                             class="hidden border border-gray-300 dark:border-gray-600 
                                    p-3 rounded dark:text-gray-200">
                            <?php
                    ...
                    <div id="sec_edu" class="hidden p-3 border border-gray-300 dark:border-gray-600 rounded">
                        ...
                        <div id="lista_educadores"
                             class="hidden border border-gray-300 dark:border-gray-600 
                                    p-3 rounded dark:text-gray-200"></div>
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <a href="admin.php"
                           class="w-[40%] px-4 py-2 bg-gray-500 dark:bg-gray-600 text-white 
                                  text-center rounded hover:bg-gray-600 dark:hover:bg-gray-500 transition">
                            Cancelar
                        </a>

                        <button type="submit"
                                class="w-[40%] px-4 py-2 bg-green-600 dark:bg-green-700 text-white 
                                       rounded hover:bg-green-700 dark:hover:bg-green-600 transition">
                            Criar Reunião
                        </button>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("formReuniao").addEventListener("submit", function (e) {
        ...
        .then(data => {
            if (data.success) {
                window.location.href = "listarreu.php?sucesso=adicionado";
            } else {
                mostrarMensagem("reset", data.erro || "Erro ao criar reunião.");
            }
        });
    });
