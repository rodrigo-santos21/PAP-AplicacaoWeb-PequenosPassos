...
<?php
function linkMobileAdmin($file, $text, $pagina) {
    $ativo = $pagina === $file;
...
echo linkMobileAdmin("admin.php", "Página Inicial", $pagina);
echo linkMobileAdmin("adicionarutl.php", "Adicionar Utilizador", $pagina);
echo linkMobileAdmin("listarutl.php", "Lista Utilizadores", $pagina);
echo linkMobileAdmin("adicionaratv.php", "Adicionar Atividade", $pagina);
echo linkMobileAdmin("listaratv.php", "Listar Atividades", $pagina);
echo linkMobileAdmin("adicionarreu.php", "Adicionar Reunião", $pagina);
echo linkMobileAdmin("listarreu.php", "Listar Reuniões", $pagina);
echo linkMobileAdmin("adicionarsala.php", "Adicionar Sala", $pagina);
echo linkMobileAdmin("listarsala.php", "Listar Salas", $pagina);
echo linkMobileAdmin("adicionarcri.php", "Adicionar Criança", $pagina);
echo linkMobileAdmin("listacri.php", "Listar Crianças", $pagina);
echo linkMobileAdmin("listaroco.php", "Listar Ocorrências", $pagina);
echo linkMobileAdmin("adicionar_menu_semana.php", "Adicionar Refeições", $pagina);
echo linkMobileAdmin("listarrefeicao.php", "Listar Refeições", $pagina);
echo linkMobileAdmin("admin_presencas.php", "Presenças", $pagina);
echo linkMobileAdmin("logs.php", "Consultar Logs", $pagina);
?>
